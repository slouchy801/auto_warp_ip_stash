...
// ==========================================
// 🍏 3. 完美實現：8 節點矩陣 + 雙層策略組 YAML 構建器 (v2.1.0h 原版穩定架構)
// ==========================================
    ...
    <body>
        <div class="container">
            <div class="time-banner">
                <span>⚡ Auto-WIS 矩陣分流完全體 (v2.1.0h 穩定還原版)</span>
            ...
            <div class="card">
                ...
                <p>📡 輸出模式：<span class="ip-badge" style="background:#fff3e0; color:#e65100;">4 IP × 2 Port 交叉混合矩陣 (共8節點原封不動)</span></p>
            </div>
